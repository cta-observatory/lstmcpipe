...
# Required arguments
parser.add_argument('--gamma_file', '-fg', type=str,
                    dest='gamma_file',
...
if __name__ == "__main__":
    ...
    ax = ctaplot.plot_angular_resolution_per_energy(gamma.reco_alt, gamma.reco_az, gamma.mc_alt, gamma.mc_az, gamma.reco_energy,
                                                    ax=ax,
                                                    label='all gammas',
                                                   )
    ax = ctaplot.plot_angular_resolution_per_energy(selected_gamma.reco_alt, selected_gamma.reco_az,
                                                    selected_gamma.mc_alt, selected_gamma.mc_az,
    ...
    ax = ctaplot.plot_energy_resolution(gamma.mc_energy, gamma.reco_energy, 
                                        label='all gammas',
                                        ax=ax,
                                       )
    ax = ctaplot.plot_energy_resolution(selected_gamma.mc_energy, selected_gamma.reco_energy,
                                        label='selected gammas',
                                        ax=ax,
                                       )
    ax.legend()
