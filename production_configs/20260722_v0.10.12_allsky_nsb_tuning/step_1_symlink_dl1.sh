#!/usr/bin/env bash
#
# First step : merge the TestingDataset and TrainingDataset from the 20240918 production into a single TestingDataset in the 20260722 production. This is because we want to use the full statistics of the dec_6166 GammaDiffuse for tests. 
#
