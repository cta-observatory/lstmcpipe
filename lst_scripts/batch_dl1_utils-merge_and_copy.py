...
import argparse
from .data_management import move_dir_content

parser = argparse.ArgumentParser(description="Batch the move_dir_content stage of the merge_and_copy_dl1 script.")
